...
module soc_system_mm_interconnect_0 (
	...
	wire  [114:0] pio_2_s1_agent_rf_source_data;                            // pio_2_s1_agent:rf_source_data -> pio_2_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pio_2_s1_agent_rsp_fifo_out_data;                         // pio_2_s1_agent_rsp_fifo:out_data -> pio_2_s1_agent:rf_sink_data
	...
	wire  [114:0] pio_3_s1_agent_rf_source_data;                            // pio_3_s1_agent:rf_source_data -> pio_3_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pio_3_s1_agent_rsp_fifo_out_data;                         // pio_3_s1_agent_rsp_fifo:out_data -> pio_3_s1_agent:rf_sink_data
	...
	wire  [113:0] pio_0_s1_agent_rp_data;                                   // pio_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [113:0] pio_1_s1_agent_rp_data;                                   // pio_1_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [113:0] pio_2_s1_agent_rp_data;                                   // pio_2_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [113:0] pio_3_s1_agent_rp_data;                                   // pio_3_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> pio_0_s1_burst_adapter:sink0_data
	...
	wire  [113:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> pio_1_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // pio_1_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> pio_1_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> pio_2_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // pio_2_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> pio_2_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] pio_2_s1_burst_adapter_source0_data;                      // pio_2_s1_burst_adapter:source0_data -> pio_2_s1_agent:cp_data
	wire          pio_2_s1_burst_adapter_source0_ready;                     // pio_2_s1_agent:cp_ready -> pio_2_s1_burst_adapter:source0_ready
	wire    [3:0] pio_2_s1_burst_adapter_source0_channel;                   // pio_2_s1_burst_adapter:source0_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [113:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> pio_3_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // pio_3_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> pio_3_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] pio_3_s1_burst_adapter_source0_data;                      // pio_3_s1_burst_adapter:source0_data -> pio_3_s1_agent:cp_data
	wire          pio_3_s1_burst_adapter_source0_ready;                     // pio_3_s1_agent:cp_ready -> pio_3_s1_burst_adapter:source0_ready
	wire    [3:0] pio_3_s1_burst_adapter_source0_channel;                   // pio_3_s1_burst_adapter:source0_channel -> pio_3_s1_agent:cp_channel
